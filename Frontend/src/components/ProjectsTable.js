                    ...
                    onClick={async () => {
                      ...
                      navigate('/soe', {
                        state: {
                          ...
                          projProfName: row.pi,
                          project_grant: row.project_grant,
                          table_data: json_response,
                          summary_table_data: json_response2,
                    ...
                    <Button
                      ...
                      onClick={async () => {
                        if (
                          ...
                          const resp3 = await fetch(`${BACKEND_URL}/project/`, {
                            method: 'POST',
                            headers: {
                              'Content-Type': 'application/json',
                              'jwt-token': localStorage.getItem('token'),
